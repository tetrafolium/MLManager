...
public class UtilsUI {
  ...
  public static Drawer setNavigationDrawer(
      final Activity activity, final Context context, final Toolbar toolbar,
    ...
    BadgeStyle badgeStyle =
        new BadgeStyle(badgeColor, badgeColor).withTextColor(Color.GRAY);
    ...
    if (MLManagerApplication.isPro()) {
      drawerBuilder.addDrawerItems(
          new PrimaryDrawerItem()
              .withName(context.getResources().getString(R.string.action_apps))
          ...
          new PrimaryDrawerItem()
              ...
              .withBadge(favoriteApps)
              .withBadgeStyle(badgeStyle)
              .withIdentifier(3),
          new DividerDrawerItem(),
          new PrimaryDrawerItem()
              .withName(
                  context.getResources().getString(R.string.action_hidden_apps))
      ...
      drawerBuilder.addDrawerItems(
          ...
          new DividerDrawerItem(),
          new SecondaryDrawerItem()
              .withName(context.getResources().getString(R.string.action_buy))
              .withIcon(GoogleMaterial.Icon.gmd_shop)
              .withBadge(context.getResources().getString(
