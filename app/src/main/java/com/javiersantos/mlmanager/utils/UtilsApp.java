...
public static File getOutputFilename(final AppInfo appInfo) {
	return new File(getAppFolder().getPath() + "/" + getAPKFilename(appInfo) +
	                ".apk");
}
...
public static void goToGooglePlus(final Context context, final String id) {
	context.startActivity(new Intent(
				      Intent.ACTION_VIEW, Uri.parse("https://plus.google.com/" + id)));
}
 ...
 */
public static Boolean isAppFavorite(final String apk,
                                    final Set<String> appFavorites) {
	Boolean res = false;
 ...
 */
public static void setAppFavorite(final Context context,
                                  final MenuItem menuItem,
                                  final Boolean isFavorite) {
	if (isFavorite) {
		menuItem.setIcon(
			ContextCompat.getDrawable(context, R.drawable.ic_star_white));
	} else {
		menuItem.setIcon(
			ContextCompat.getDrawable(context, R.drawable.ic_star_border_white));
	}
}
 ...
 */
public static Boolean isAppHidden(final AppInfo appInfo,
                                  final Set<String> appHidden) {
	Boolean res = false;
 ...
 */
public static void setAppHidden(final Context context,
                                final FloatingActionButton fabHide,
 ...
 */
public static Boolean saveIconToCache(final Context context,
 ...
 */
public static Boolean removeIconFromCache(final Context context,
                                          final AppInfo appInfo) {
 ...
 */
public static Drawable getIconFromCache(final Context context,
                                        final AppInfo appInfo) {
	Drawable res;
...
public static Boolean extractMLManagerPro(final Context context,
                                          final AppInfo appInfo) {
	Boolean res = false;
	File finalFile =
		new File(getAppFolder().getPath(), getAPKFilename(appInfo) + ".png");

	try {
		File fileUri =
			new File(context.getCacheDir(), getAPKFilename(appInfo) + ".png");
		FileOutputStream out = new FileOutputStream(fileUri);
		Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(),
		                                             R.drawable.banner_troll);
