...
public class MLManagerApplication extends Application {
  ...
  public static AppPreferences getAppPreferences() { return sAppPreferences; }

  /**
   * Retrieve ML Manager Pro
   * @return true for ML Manager Pro, false otherwise
   */
  public static Boolean isPro() { return isPro; }

  public static void setPro(final Boolean res) { isPro = res; }
